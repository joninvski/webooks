<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pesquisaHistoricoEncomendas.aspx.cs" Inherits="Web_pesquisaHistorico" Title="WEBooks [Pesquisa Historico]" %>
   ...
   { %>
    ...
    <asp:GridView ID="HistoricoEncomendas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnRowCommand="OperacaoEncomenda">
            ...
            <Columns>
                ...
                <asp:ButtonField CommandName="MostraDestalhes" ButtonType="Button" Text="Destalhes" />
    ...
    <asp:Table ID="tabelaEncomenda" runat="server" BorderStyle="Solid" BorderWidth="2px" CellPadding="3" CellSpacing="1" BorderColor="black">
        <asp:TableRow ID="TableRow1" runat="server" BorderWidth="2px">
            <asp:TableCell ID="TableCell1" runat="server" BorderWidth="2px"> <asp:Label ID="Label1" runat="server" Text="Numero Encomenda" Font-Bold="true"></asp:Label> </asp:TableCell>
        ...
        <asp:TableRow ID="TableRow3" runat="server" BorderWidth="2px">   
            <asp:TableCell ID="TableCell2" runat="server" BorderWidth="2px"><asp:Label ID="Label2" runat="server" Text="Nome Comprador" Font-Bold="true"></asp:Label></asp:TableCell>
        ...
        <asp:TableRow ID="TableRow4" runat="server" BorderWidth="2px">    
            <asp:TableCell ID="TableCell5" runat="server" BorderWidth="2px"><asp:Label ID="Label3" runat="server" Text="Data do CheckOut" Font-Bold="true"></asp:Label></asp:TableCell>
        ...
        <asp:TableRow ID="TableRow5" runat="server" BorderWidth="2px">    
            <asp:TableCell ID="TableCell10" runat="server" BorderWidth="2px"><asp:Label ID="Label4" runat="server" Text="Estado" Font-Bold="true"></asp:Label></asp:TableCell>
        ...
        <asp:TableRow ID="TableRow6" runat="server" BorderWidth="2px">    
            <asp:TableCell ID="TableCell13" runat="server" BorderWidth="2px"><asp:Label ID="Label5" runat="server" Text="Valor Total" Font-Bold="true"></asp:Label></asp:TableCell>
            <asp:TableCell ID="TableCell14" runat="server" BorderWidth="1"><asp:Label ID="lbValorTotal" runat="server"></asp:Label></asp:TableCell>
            <asp:TableCell ID="TableCell15" runat="server" Width="60%" > </asp:TableCell>
        </asp:TableRow>
        
        <asp:TableRow ID="TableRow2" runat="server" BorderWidth="2px">
            <asp:TableCell ID="TableCell16" runat="server" BorderWidth="2" ColumnSpan="3"><asp:Label ID="Label6" runat="server" Text="Livros da Encomenda" Font-Bold="true"></asp:Label></asp:TableCell>
        </asp:TableRow>
        
        <asp:TableRow ID="TableRow7" runat="server" BorderWidth="2px">
            <asp:TableCell ID="TableCell17" runat="server" BorderWidth="2" ColumnSpan="3">
