<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LivrosComDesconto.aspx.cs" Inherits="Web_procura" Title="WEBooks [Livros com Desconto]" %>
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContentHolder" runat="server">
    <h1>Livros com Desconto</h1>
</asp:Content>

<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyContentHolder" Runat="Server">   
    <center>
        <center >
        <asp:GridView ID="DescontoGrid" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:BoundField DataField ="TempoEntrega" HeaderText="Tempo de Entrega"  />
            </Columns>
